defmodule LearnWebdevWithElixirWeb do
  @moduledoc """
  ...
  def controller do
    quote do
      use Phoenix.Controller, namespace: LearnWebdevWithElixirWeb
  ...
  def view do
    quote do
      use Phoenix.View,
        root: "lib/learn_webdev_with_elixir_web/templates",
        namespace: LearnWebdevWithElixirWeb
